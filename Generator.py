...
print("Добро пожаловать в 'подбор'  имён для напарника' как в сериале '"
      "Ясновидец']\n")
...
while True:
      ...
      try_again = input("Попробуйте еще? ( Нажмите Enter чтобы продолжить. Либо 'n'  чтобы выйти)")
      if try_again.lower() == "n":
            break

      input("\nНажмите enter для завешения работы")